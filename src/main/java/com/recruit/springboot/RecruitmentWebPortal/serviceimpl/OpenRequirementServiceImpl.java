...
//         if (!existing.getCreatedBy().equals(currentUser) && !isAdmin()) {
//             throw new RuntimeException("Unauthorized to update this requirement.");
//         }
...
//         if (!existing.getCreatedBy().equals(currentUser) && !isAdmin()) {
//             throw new RuntimeException("Unauthorized to delete this requirement.");
//         }
